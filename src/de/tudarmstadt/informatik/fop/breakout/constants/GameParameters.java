...
public interface GameParameters {
	...
	String BACKGROUND_SPRITESHEET = "/images/background_spritesheet.png";
	...
	int MAP_COUNT = 3;
	//int MAP_COUNT_MULTIPLAYER = 3;
	int BLOCK_DEATH_ANIMAION_LENGTH = 300;
	String SIMPLE_BLOCK_1_SPRITESHEET = "/images/simpleBlock1-spritesheet.png";
	String SIMPLE_BLOCK_1_DEATH_SPRITESHEET = "/images/simpleBlock1-death-spritesheet.png";
	String SIMPLE_BLOCK_2_SPRITESHEET = "/images/simpleBlock2-spritesheet.png";
	String SIMPLE_BLOCK_2_DEATH_SPRITESHEET = "/images/simpleBlock2-death-spritesheet.png";
	String SIMPLE_BLOCK_3_SPRITESHEET = "/images/simpleBlock3-spritesheet.png";
	String SIMPLE_BLOCK_3_DEATH_SPRITESHEET = "/images/simpleBlock3-death-spritesheet.png";

	int		BLOCK_WIDTH = 50;
	int		BLOCK_HEIGHT = 30;
	String	RAM_BLOCK_SPRITESHEET = "/images/ram-block-spritesheet.png";
	String	RAM_BLOCK_DEATH_SPRITESHEET = "/images/ram-block-death-spritesheet.png";
	float	RAM_BLOCK_ACCELERATION = 0.0001F;
	int		RAM_BLOCK_REST_TIME = 1500;
	float	RAM_BLOCK_REBOUND_VELOCITY = 0.01F;
	int BLOCK_DEFAULT_SCOREPOINTS = 10;
	int BLOCK_RAM_SCOREPOINTS = 20;
	...
	String BALL_SPRITESHEET = "/images/ball-spritesheet.png";

	// StickModel
	String STICK_ID = "stick";
	String STICK_ID_PLAYER2 = "stick_2";
	float STICK_SPEED = 1f;
	String STICK_MIDDLE_IMAGE = "/images/stick-middle.png";
	String STICK_LEFT_IMAGE = "/images/stick-side-l.png";
	String STICK_RIGHT_IMAGE = "/images/stick-side-r.png";
	...
	//Particle systems
	String FLAME_PARTICLE_IMAGE = "/images/flame-particle.png";
	String FLAME_LEFT_EMITTER_FILE = "/emitter/flame-l.xml";
	String FLAME_RIGHT_EMITTER_FILE = "/emitter/flame-r.xml";
	...
	int PLAYER_VIEW_SCORE_DISTANCE_Y = 50;

	// Pause
	String PAUSE_ID = "pause";
	String PAUSE_IMAGE_ID = "pause_image";
	String PAUSE_IMAGE = "/images/pause.png";
	...
	int HIGHSCORE_TITLE_START_Y = 50;
	int HIGHSCORE_ENTRY_START_Y = 200;
	int HIGHSCORE_ENTRY_GAP = 4;
	String HIGHSCORE_TITLE_TEXT = "Highscores";
	...
	//String MAP_FILE_PREFIX_MULTIPLAYER = "level";
	String MAP_FILE_EXT 	= ".map";
	double MAP_REAL_HEIGHT = 50000;
	double MAP_GRAVITY = 9.81F;

	// Menu
	String 	ENTRY_IMAGE = "/images/entry.png";
	String 	ENTRY_OVER_IMAGE = "/images/entry_over.png";
	String 	ENTRY_DOWN_IMAGE = "/images/entry_down.png";
	String ENTRY_IMAGE_SMALL = "/images/entry_small.png";
