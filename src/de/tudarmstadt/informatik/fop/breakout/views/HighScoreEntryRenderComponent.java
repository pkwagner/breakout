 ...
 */
public class HighScoreEntryRenderComponent extends RenderComponent {
     ...
     */
    public HighScoreEntryRenderComponent(int rank, IHighscoreEntry entry,GameContainer gameContainer) throws SlickException {
    ...
    public HighScoreEntryRenderComponent(int rank, String name, String blocks, String time, String score, GameContainer gameContainer){
