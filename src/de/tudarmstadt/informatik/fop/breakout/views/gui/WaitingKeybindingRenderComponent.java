 ...
 *
 * @see de.tudarmstadt.informatik.fop.breakout.models.KeyBinding
 */
public class WaitingKeybindingRenderComponent extends RenderComponent {

    private static final String WAITING_TEXT = "Click any key";

    public WaitingKeybindingRenderComponent(String id) {
        super(id);
    }
